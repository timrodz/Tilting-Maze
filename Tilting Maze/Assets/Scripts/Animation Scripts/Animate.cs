...
public class Animate : MonoBehaviour {
	...
	// Obtain the object's transform component
	void Awake() {

		//objectToAnimate = GetComponent<Transform>();
	...
	public static IEnumerator FadeIn(Transform _obj, float duration) {

		for (float t = 0.0f; t <= 1.0f; t += (Time.deltaTime / duration)) {
			
			_obj.GetComponent<CanvasRenderer>().SetAlpha(t);
			yield return null;
	...
	public static IEnumerator FadeOut(Transform _obj, float duration) {
